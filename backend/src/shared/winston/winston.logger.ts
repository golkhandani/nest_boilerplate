...
import { winstonConstants } from '@constants/index';
...
const winstonInstance = new Logger(winstonConstants.LOGGER_SERVICE_NAME);
export const WinstonOptions = winstonInstance.options;
export const WinstonLogger = winstonInstance.logger;

export const WinstonLoggerName = 'winston';
